...
NoLiMa’s headline result is worth holding onto precisely because of how large the gap it exposes is: **Llama 4 Scout’s effective length measured 1,000 tokens, against a marketed 10,000,000** — a base short-context score of 81.7, falling to 72.3 at 1K, 61.8 at 2K, 50.8 at 4K, 35.5 at 8K, 26.9 at 16K, and 21.6 at 32K. By 32K tokens — 0.32% of the marketed window — the model retains barely a quarter of its own short-context capability. Scout is the most extreme case in the paper, but it is not an isolated one — NoLiMa reports steep degradation well before the advertised window across most of the long-context models it tested. Check the paper’s own results table for the current figures rather than taking that summary second-hand; the per-model numbers are the part worth reading closely.
